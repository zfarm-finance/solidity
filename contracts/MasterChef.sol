...
contract MasterChef is Ownable {
    ...
    function add(
        ...
        poolInfo.push(
            PoolInfo({
                ...
                enableForDeposit: _enableForDeposit
            })
        );
    }
    ...
    function set(
        ...
        poolInfo[_pid].enableForDeposit = _enableForDeposit;
    }
    ...
    function updatePool(uint256 _pid) public {
        ...
        // dev fee
        cake.mint(devaddr, cakeReward.mul(devfee).div(100));
    ...
    function setDevfee(uint256 _devfee) public onlyOwner {
        require(_devfee <= 100);
        require((100 % _devfee) == 0, "100 must be divisible by devfee.");
        devfee = _devfee;
    }
